...
export const en = {
  ...
  landing_feature1_title: 'Demand Capture',
  landing_feature1_desc:
    'Buyers submit orders in plain language. Requirements are structured into crop, grade, quantity, and delivery specs automatically.',
  landing_feature2_title: 'Farm Allocation',
  landing_feature2_desc:
    'Orders are split across nearby farms before harvest. Small producers pool together to fill large orders reliably.',
  landing_feature3_title: 'Order Fulfillment',
  landing_feature3_desc:
    'Each farm receives clear harvest instructions. Batches are tracked from field to buyer with full traceability.',
  landing_why_title: 'What Changes With SooqRoot',
  landing_why_anchor: 'Most systems react after harvest. SooqRoot plans before it.',
  landing_why_item1: 'Buyers commit before harvest',
  landing_why_item2: 'Farmers produce against confirmed demand',
  landing_why_item3: 'Small farms act as one supplier',
  landing_why_item4: 'Orders are fulfilled with full visibility',
  landing_flow_title: 'How SooqRoot Works',
  landing_flow_step1: 'Request Demand',
  landing_flow_step2: 'Allocate Supply',
  landing_flow_step3: 'Harvest to Order',
  landing_flow_step4: 'Deliver Confirmed',
  landing_flow_step1_desc: 'Buyer submits demand',
  landing_flow_step2_desc: 'Farms are matched & pooled',
  landing_flow_step3_desc: 'Farmers receive instructions',
  landing_flow_step4_desc: 'Traceable delivery to buyer',
...
export const ar: Record<keyof typeof en, string> = {
  ...
  landing_feature1_title: 'التقاط الطلب',
  landing_feature1_desc:
    'يقدّم المشترون طلباتهم بلغة عادية. تُهيكل المتطلبات تلقائياً إلى محصول وجودة وكمية ومواصفات تسليم.',
  landing_feature2_title: 'تخصيص المزارع',
  landing_feature2_desc:
    'تُوزّع الطلبات على مزارع قريبة قبل الحصاد. المنتجون الصغار يتجمّعون لتلبية الطلبات الكبيرة بموثوقية.',
  landing_feature3_title: 'تنفيذ الطلبات',
  landing_feature3_desc:
    'كل مزرعة تتلقى تعليمات حصاد واضحة. تُتتبّع الدفعات من الحقل إلى المشتري بتتبّع كامل.',
  landing_why_title: 'ما الذي يتغير مع سوق روت',
  landing_why_anchor: 'معظم الأنظمة تتفاعل بعد الحصاد. سوق روت يخطط قبله.',
  landing_why_item1: 'المشترون يلتزمون قبل الحصاد',
  landing_why_item2: 'المزارعون ينتجون بناءً على طلب مؤكد',
  landing_why_item3: 'المزارع الصغيرة تعمل كمورد واحد',
  landing_why_item4: 'يتم تنفيذ الطلبات برؤية كاملة',
  landing_flow_title: 'كيف يعمل سوق روت',
  landing_flow_step1: 'طلب الاحتياج',
  landing_flow_step2: 'تخصيص الإمداد',
  landing_flow_step3: 'الحصاد حسب الطلب',
  landing_flow_step4: 'التسليم المؤكد',
  landing_flow_step1_desc: 'المشتري يقدّم طلبه',
  landing_flow_step2_desc: 'تُطابق المزارع وتُجمّع',
  landing_flow_step3_desc: 'المزارعون يستلمون التعليمات',
  landing_flow_step4_desc: 'تسليم قابل للتتبّع للمشتري',
